...
<h2><p align="center">Все студенты <c:out value="${course}" />  курса <c:out value="${flow}" /> потока </p>
...
<p align="center">
    <a href="/webapp/timetable/course/${course}/flow/${flow}">Расписание поточных занятий</a>
    <a href="/webapp/add_student">Добавить студента</a></p>
