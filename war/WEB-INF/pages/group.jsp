...
<h2><p align="center">Все студенты <c:out value="${number}" />  группы </p></h2>
<table align="center">
    <tr>
        <th>ФИО</th>
        <th>Курс</th>
...
<p align="center">
    <a href="/webapp/timetable/group/${Id}">Расписание группы</a>
    <a href="/webapp/add_student">Добавить студента</a>
</p>
