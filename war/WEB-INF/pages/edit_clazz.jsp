...
<h2><p align="center">Изменение данных занятия</p></h2>
<p align="center">
...
<div align="center">
    <c:url value="/webapp/edit_clazz" var="var"/>
    <form:form method="post" action="${var}" modelAttribute="clazz">
        <table border="0">
            <form:input type="hidden" path="clazz.classId"/>
            <tr>
                <td>Курс:</td>
                <td>
                    <form:select path = "courseId">
                        <form:option value = "${clazz.clazz.courseByCourseId.courseId}" label = "${clazz.clazz.courseByCourseId.name} ${clazz.clazz.courseByCourseId.yearOfStudy} курс, ${clazz.clazz.courseByCourseId.year}г."/>
            ...
            <tr>
                ...
                <td>
                    <form:select path = "professorId">
                        <form:option value = "${clazz.clazz.professorByProfessorId.professorId}" label = "${clazz.clazz.professorByProfessorId.fullName}"/>
            ...
            <tr>
                ...
                <td>
                    <form:select path = "lectureHallId">
                        <form:option value = "${clazz.clazz.lectureHallByLectureHallId.lectureHallId}" label = "${clazz.clazz.lectureHallByLectureHallId.number}"/>
            ...
            <tr>
                <td colspan="2" align="center"><input type="submit" value="Изменить данные занятия"/></td>
            </tr>
        </table>
    </form:form>
</div>
